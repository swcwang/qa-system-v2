...
class QAConfig:
    ...
    chroma_path: str = "./data/chroma_db_mid_june9" # "./data/chroma_db_large"
    collection_name: str = "qa_optimized" #"qa_chunks" #"qa_chunks_v2"
    ...
    # Data paths
    duck_db_name: str = "./data/qanda_mid_june9.duckdb" #"./data/qanda_may.duckdb" #"./data/qanda_v2.duckdb"
